package eu.le_tian.iConsoleOS.heartbeat;
...
public class HeartBeat extends AppCompatImageView {
    ...
    private void populateFromAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            scaleFactor = a.getFloat(R.styleable.HeartBeat_scaleFactor, DEFAULT_SCALE_FACTOR);
            reductionScaleFactor = -scaleFactor;
            duration = a.getInteger(R.styleable.HeartBeat_duration, DEFAULT_DURATION);
        } finally {
            a.recycle();
        }
