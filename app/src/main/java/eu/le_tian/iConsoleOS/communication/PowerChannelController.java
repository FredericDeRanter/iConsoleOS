package eu.le_tian.iConsoleOS.communication;
...
public class PowerChannelController {
        ...
        if (null != mAntChannel) {
            if (mIsOpen) {
                ...
                try {
                    ...
                    Log.v(TAG, "Opened channel with device number: " + POWER_SENSOR_ID);
    ...
    public class ChannelEventCallback implements IAntChannelEventHandler {
        ...
        public void onReceiveMessage(MessageFromAntType messageType, AntMessageParcel antParcel) {
            Log.v(TAG, "Rx: " + antParcel);
            Log.v(TAG, "Message Type: " + messageType);
            ...
            switch (messageType) {
                ...
                case ACKNOWLEDGED_DATA:
                    ...
                    Log.v(TAG, "AcknowledgedDataMessage: " + payload);
